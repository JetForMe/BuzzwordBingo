...
let kPlayerIDJulia						=	UUID("CFDA3CC9-9C8A-4616-A4E5-6F31C74E5794")!
...
SeedGames : AsyncMigration
{
	...
	*/
	...
	[
		(kWordIDTrees, kGameIDShatner2025, "Trees"),
		(kWordIDHorses, kGameIDShatner2025, "Horses"),
		(kWordIDWhat, kGameIDShatner2025, "Aliens"),
		(UUID("93355D58-4201-46DC-B2CB-6983D6E1BAA2")!, kGameIDShatner2025, "What?"),
		(UUID("1832FE5A-5C76-461A-BE43-C1780568C6F5")!, kGameIDShatner2025, "Intimidation"),
		(UUID("5D252992-AEB4-4CBD-AC9D-44335A94211C")!, kGameIDShatner2025, "Set"),
		(UUID("32665FE7-02A4-4FF2-A033-4CC660E300DF")!, kGameIDShatner2025, "Blue Origin"),
		(UUID("4552F8B9-F006-431A-8107-3B241CE43174")!, kGameIDShatner2025, "Album"),
		(UUID("AAD0C7FE-DC80-4F67-BAD6-40F06A81FF4F")!, kGameIDShatner2025, "Sharks"),
		(UUID("DB3FBB25-5AB6-4527-B4C2-5E6DC74FEC0C")!, kGameIDShatner2025, "Antarctica"),
		(UUID("799E22BA-3BCB-49B3-8E22-A282C9AF5AC1")!, kGameIDShatner2025, "Mortality"),
		(UUID("52046CDB-8E27-4564-8062-F01446D43B25")!, kGameIDShatner2025, "The Universe"),
		(UUID("A4FCBC22-C0CD-427D-8B92-FD854940AB86")!, kGameIDShatner2025, "Consciousness"),
		(UUID("8A83172A-AD20-4FDC-BB40-F7166DD44430")!, kGameIDShatner2025, "Energy"),
		(UUID("0C7B900C-9037-4773-8420-6959E8C18349")!, kGameIDShatner2025, "Ego"),
		(UUID("07BFCCA5-D812-4B31-8B29-E1E2D64EA057")!, kGameIDShatner2025, "Time"),
		(UUID("B2F6F151-8C20-494E-A50E-757AAC4C02E9")!, kGameIDShatner2025, "Reality"),
		(UUID("9F777272-92F5-47B8-A535-D724BD4DB3BA")!, kGameIDShatner2025, "Life and Death"),
		(UUID("05F2E418-E3AB-42C0-BF90-DF05B4A904D2")!, kGameIDShatner2025, "Humanity"),
		(UUID("626DD190-7A59-4352-8E30-D5F9F36DC649")!, kGameIDShatner2025, "Poetry"),
		(UUID("E6F22E9B-9A9A-49C6-A030-11ADDCA3BFFB")!, kGameIDShatner2025, "Motorcycles"),
		(UUID("7035100D-1065-43B0-A4E0-B2414027922B")!, kGameIDShatner2025, "Nashville"),
		(UUID("734BF5E4-AD60-4745-9ED3-272C4F8411C5")!, kGameIDShatner2025, "Mispronounces Common Word"),
		(UUID("7D8FF186-7192-4EBE-B043-6B416B4C1902")!, kGameIDShatner2025, "Talks over Audience"),
		(UUID("EE221BE2-4240-44A1-B781-99DADD50823E")!, kGameIDShatner2025, "Twilight Zone"),
		(UUID("A7B11434-8045-4863-A19C-A65FCF9871E4")!, kGameIDShatner2025, "Leonard"),
		(UUID("86BBE476-C9C3-4D09-9D02-D1547376DDCA")!, kGameIDShatner2025, "Conventions"),
		(UUID("591BB766-C1AD-4E5F-A69D-81291C01FF54")!, kGameIDShatner2025, "“Just Realized”"),
	]
